# PowerShell script to update GitHub label colors
...
$labelUpdates = @(
    ...
    @{ Name = "comp: security"; Color = "91c764"; Description = "Security component" }
    @{ Name = "comp: execution"; Color = "91c764"; Description = "Execution component" }
    @{ Name = "comp: test"; Color = "91c764"; Description = "Test component" }
    @{ Name = "comp: ci"; Color = "91c764"; Description = "CI/CD component" }
    @{ Name = "comp: docs"; Color = "91c764"; Description = "Documentation component" }
